...
public interface Randoms {
    ...
    default double calculaTempo(double time) {
        ...
        if (val) time +=((double) (Math.random() * (0.17 - 0.02)) + 0.02);
        else{
        ...
        time *= 1-(((double) (Math.random() * (0.9 - 0.01)) + 0.01));
        }
        return time;
    }
    ...
    default double atraso(){
        ...
        if (val){
            ...
            switch (caso){
                ...
                atraso = (double) (Math.random() * (0.47 - 0.05)) + 0.05;
                break;
                
                case 2:
                //atraso 35 a 55 minutos
                atraso = (double) (Math.random() * (0.92 - 0.58)) + 0.58;
                break;
                
                case 3:
                //atraso de 1 hora a 4 horas 
                atraso = (double) (Math.random() * (4 - 1)) + 1;
                break;
            }
        }
        return atraso;
