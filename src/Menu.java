...
public class Menu {
    ...
    public static String userMenuData(int i){
        StringBuilder sb = new StringBuilder("----------MENU UTILIZADOR-----------\n\n");
        if (i==1)sb.append("Digite um cÛdigo da entidade:\n ");
        else if (i==2) sb.append("Digite a sua avaliacao(1-10):\n ");
        else if (i==3) sb.append("Digite o cÛdigo de uma loja:\n ");
    ...
    public static String getSpecificContaInfo(int i){
        if (i==1) System.out.print("Raio de AÁ„o: ");
    ...
    public static void errors(int i){
        ...
        else if (i==2) sb.append("****N„o foi possÌvel guardar o Estado***").append("\n");
        ...
        else if (i==6) sb.append("****N„o foi possÌvel carregar o Estado***").append("\n");
        System.out.print(sb.toString());
    }
    ...
    public static Utilizador menuRegistoUtilizador() {
        ...
        System.out.print("C√≥digo da conta: ");
        ...
        System.out.print("Coordenadas (separadas por um espa√ßo, em formato decimal): ");
    ...
    public static Voluntario menuRegistoVoluntario() {
        ...
        StringBuilder sb = new StringBuilder("------------REGISTAR VOLUNT√ÅRIO---------\n\n");
        sb.append("Introduza os dados a seguir pedidos.\n\n");
        sb.append("Nome: ");
